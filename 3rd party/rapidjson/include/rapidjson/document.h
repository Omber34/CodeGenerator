...
public:
    ...
    */
    ...
    /*!
        ...
        \note \c Class is always pass-by-value.
    ...
    */
    ...
    /*!
        ...
        \note Complexity is quadratic in Class's member number and linear for the rest (number of all values in the subtree and total lengths of all strings).
    */
    template <typename SourceAllocator>
